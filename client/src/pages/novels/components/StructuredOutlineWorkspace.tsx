...
export default function StructuredOutlineWorkspace(props: StructuredTabViewProps) {
  ...
  const sections = [
    ...
    { id: "volumes", label: "卷管理" },
    { id: "beatSheet", label: "节奏板" },
    { id: "chapters", label: "章节列表" },
    { id: "chapterDetail", label: "章节详情" },
    { id: "sync", label: "同步工具" },
  ];
      ...
      <div className="w-64 shrink-0">
        <Card className="h-full flex flex-col">
          <CardHeader className="sticky top-0 z-10 bg-background border-b">
            <CardTitle className="text-lg">节奏 / 拆章</CardTitle>
          </CardHeader>
      ...
      <div className="flex-1">
        <Card className="h-full flex flex-col">
          <CardContent className="flex-1 overflow-y-auto">
            ...
            {activeSection === "beatSheet" && (
              <div className="space-y-4">
                <CardHeader className="sticky top-0 z-10 bg-background border-b mb-4">
                  <CardTitle>节奏板</CardTitle>
                </CardHeader>
                <Card>
                  <CardHeader className="pb-3">
                        ...
                        {visibleChapters.map((chapter) => {
                          ...
                          return (
                            <button
                              ...
                              type="button"
                              onClick={() => {
                                patchWorkspace(workspaceId, { selectedChapterId: chapter.id });
                                setActiveSection("chapterDetail");
                              }}
                              className={cn(
                                "w-full rounded-xl border p-3 text-left transition-colors",
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{syncPreview?.items.length || 0} 项差异</Badge>
                        <Button
                          size="sm"
                          variant="outline"
